...
class LipstickRecorderManager
    : public QWaylandCompositorExtensionTemplate<LipstickRecorderManager>
    , public QtWaylandServer::lipstick_recorder_manager
{
public:
    explicit LipstickRecorderManager(QWaylandCompositor *compositor);
...
protected:
    void bind_resource(Resource *resource);
