...
class ViewporterGlobal
    : public QWaylandCompositorExtensionTemplate<ViewporterGlobal>
{
public:
...
class LipstickViewport
    : public QWaylandCompositorExtensionTemplate<LipstickViewport>
    , public QtWaylandServer::wp_viewport
{
public:
    LipstickViewport(QWaylandSurface *surface
                     , uint32_t version
                     , uint32_t id
                     , QObject *parent);
